...
function changeSwatch() {
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-default.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-cerulean.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-cosmo.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-cyborg.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-darkly.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-flatly.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-journal.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-lumen.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-paper.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-readable.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-sandstone.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-simplex.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-slate.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-spacelab.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-superhero.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-united.min.css"]').remove();
    $('link[rel=stylesheet][href="/Themes/PJS.Bootstrap/Styles/site-yeti.min.css"]').remove();

    var fileref = document.createElement("link");
    fileref.setAttribute("rel", "stylesheet");
    fileref.setAttribute("type", "text/css");
    fileref.setAttribute("href", "/Themes/PJS.Bootstrap/Styles/site-" + sessionStorage.Swatch + ".min.css");
...
function changeHoverMenus() {
    if (sessionStorage.HoverMenus == 'true') {
        ...
        fileref.setAttribute("src", "/Themes/PJS.Bootstrap/Scripts/hover-dropdown.js")
        document.getElementsByTagName("body")[0].appendChild(fileref)

        $('#hovermenus').prop('checked', true);
    }
    else {
        $("script[src='/Themes/PJS.Bootstrap/Scripts/hover-dropdown.js']").remove()
